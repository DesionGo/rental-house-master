package com.rentalHouseClient.rhc.common;
...
public class CodeGenerator {
    ...
    private static String packageName = "com.com.rentalHouseAdmin.rha"; // 生成的包名
    ...
    private static String author = "rentalHouse";    // 作者
    private static String outputDir = "D://rentalHouse";   // 代码生成的路径目录
    ...
    private static String dbPassword = "19990204";
...
//                .setDbColumnUnderline(true)
                ...
                .setSuperEntityClass("com.com.rentalHouseAdmin.rha.common.entity.BaseEntity")
                .setSuperControllerClass("com.com.rentalHouseAdmin.rha.common.controller.BaseController");
