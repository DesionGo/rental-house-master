package com.rentalHouseAdmin.rha.common.ext.ueditor;

import com.rentalHouseAdmin.rha.common.ext.ueditor.define.ActionMap;
...
import com.rentalHouseAdmin.rha.common.ext.ueditor.hunter.FileManager;
import com.rentalHouseAdmin.rha.common.ext.ueditor.hunter.ImageHunter;
import com.rentalHouseAdmin.rha.common.ext.ueditor.upload.Base64Uploader;
import com.rentalHouseAdmin.rha.common.ext.ueditor.upload.BinaryUploader;
import com.rentalHouseAdmin.rha.common.ext.ueditor.upload.IStorageManager;
import com.rentalHouseAdmin.rha.common.ext.ueditor.upload.StorageManager;
...
public class ActionEnter {
    ...
    public String exec() {
        ...
        if (callbackName != null) {
            ...
            if (!validCallbackName(callbackName)) {
                return new BaseState(false, com.rentalHouseAdmin.rha.common.ext.ueditor.define.AppInfo.ILLEGAL).toJSONString();
            }
    ...
    public String invoke() {
        ...
        if (actionType == null || !ActionMap.mapping.containsKey(actionType)) {
            return new BaseState(false, com.rentalHouseAdmin.rha.common.ext.ueditor.define.AppInfo.INVALID_ACTION).toJSONString();
        }
