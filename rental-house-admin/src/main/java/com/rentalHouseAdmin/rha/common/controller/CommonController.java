package com.rentalHouseAdmin.rha.common.controller;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.rentalHouseAdmin.rha.common.constant.Constants;
import com.rentalHouseAdmin.rha.common.constant.UploadPathEnum;
...
import com.rentalHouseAdmin.rha.common.utils.FileUploadKit;
...
public class CommonController {
    ...
    public com.rentalHouseAdmin.rha.common.dto.R fileUpload(@RequestParam(value = "file") MultipartFile file, String type) {
        if (file == null) {
            return com.rentalHouseAdmin.rha.common.dto.R.fail("没有可上传的文件");
        }
        UploadPathEnum uploadPathEnum = UploadPathEnum.get(type);
        if (uploadPathEnum == null) {
            return com.rentalHouseAdmin.rha.common.dto.R.fail("不存在的上传路径类型：" + type);
        }
        return com.rentalHouseAdmin.rha.common.dto.R.ok(FileUploadKit.upload(file, uploadPathEnum));
    }
    ...
    public void download(String filePath) {
        ...
        HttpServletResponse response = com.rentalHouseAdmin.rha.common.utils.HttpServletContextKit.getHttpServletResponse();
    ...
    public com.rentalHouseAdmin.rha.common.dto.R searchUsers(String keyword) {
