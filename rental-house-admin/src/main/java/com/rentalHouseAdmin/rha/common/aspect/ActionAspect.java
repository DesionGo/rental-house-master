package com.rentalHouseAdmin.rha.common.aspect;
...
public class ActionAspect {
	...
	@Pointcut("@annotation(com.rentalHouseAdmin.rha.common.annotation.Log)")
	...
	private void saveActionLog(JoinPoint joinPoint, long time, boolean isAround) {
		...
		com.rentalHouseAdmin.rha.common.annotation.Log action = method.getAnnotation(com.rentalHouseAdmin.rha.common.annotation.Log.class);
		if(action != null){
			// 注解上的描述
