package com.rentalHouseAdmin.rha.common.shiro;

import cn.hutool.core.util.StrUtil;
import com.rentalHouseAdmin.rha.common.constant.SysConstant;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        ShiroKit.setSessionAttribute("id", user.getId());
        ShiroKit.setSessionAttribute("userName", user.getUsername());
    ...
    public void setCredentialsMatcher(CredentialsMatcher credentialsMatcher) {
        ...
        shaCredentialsMatcher.setHashAlgorithmName(com.rentalHouseAdmin.rha.common.utils.ShiroKit.HASH_ALGORITHM_NAME);
