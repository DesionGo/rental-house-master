...
public class BinaryUploader {
    ...
    public com.rentalHouseAdmin.rha.common.ext.ueditor.define.State save(HttpServletRequest request, Map<String, Object> conf) {
    ...
    protected com.rentalHouseAdmin.rha.common.ext.ueditor.define.State doSave(MultipartRequest request, Map<String, Object> conf) {
        ...
        try {
            ...
            savePath = com.rentalHouseAdmin.rha.common.ext.ueditor.PathFormat.parse(savePath, originFileName);

            String rootPath = (String) conf.get("rootPath");

            InputStream is = file.getInputStream();
            com.rentalHouseAdmin.rha.common.ext.ueditor.define.State storageState = storage.saveFileByInputStream(is, rootPath, savePath, maxSize);
            is.close();
    ...
    protected com.rentalHouseAdmin.rha.common.ext.ueditor.define.State doSave(HttpServletRequest request, Map<String, Object> conf) {
