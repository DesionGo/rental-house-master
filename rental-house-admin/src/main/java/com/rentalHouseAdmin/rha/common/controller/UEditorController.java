...
import com.rentalHouseAdmin.rha.common.ext.ueditor.ActionEnter;
    ...
    static class FileStoreUEditorUploader implements IStorageManager {
        ...
        public State saveFileByInputStream(InputStream is, String rootPath, String savePath, long maxSize) {
            ...
            try {
                ...
                fos.close();// 保存数据
                com.rentalHouseAdmin.rha.common.ext.ueditor.define.BaseState state = new com.rentalHouseAdmin.rha.common.ext.ueditor.define.BaseState(true);
