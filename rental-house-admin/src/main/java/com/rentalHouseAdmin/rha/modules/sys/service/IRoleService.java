 ...
 * @since 2019-04-29
 */
public interface IRoleService extends IService<com.rentalHouseAdmin.rha.modules.sys.entity.Role> {
     ...
     * @return
     */
    Page<com.rentalHouseAdmin.rha.modules.sys.entity.Role> listRolePage(com.rentalHouseAdmin.rha.modules.sys.entity.Role role);
