package com.rentalHouseAdmin.rha.modules.generator.utils;

import cn.hutool.core.util.StrUtil;
import com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant;
import com.rentalHouseAdmin.rha.modules.generator.constant.DbColumnTypeEnum;
import com.rentalHouseAdmin.rha.modules.generator.constant.JavaTypeEnum;
import com.rentalHouseAdmin.rha.modules.generator.constant.TemplateTypeEnum;
import com.rentalHouseAdmin.rha.modules.generator.dto.ColumnCommentValueRelationDTO;
import com.rentalHouseAdmin.rha.modules.generator.dto.ColumnConfigDTO;
import com.rentalHouseAdmin.rha.modules.generator.dto.ColumnsValueRelationDTO;
...
public class AuxiliaryKit {
     ...
     * @return list
     */
    public static List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnCommentValueRelationDTO> parseTableColumnCommentValueRelation(String columnComment) {
        List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnCommentValueRelationDTO> list = new ArrayList<>();
...
//                throw new RuntimeException("格式化列失败：无法解析列注释，注释不符合统一规范：" + vr);
                ...
                list.add(new com.rentalHouseAdmin.rha.modules.generator.dto.ColumnCommentValueRelationDTO(itemArr[0], itemArr[1]));
            }
        }
        return list;
    }
     ...
     * @param columns 列数据
     */
    public static void handleAndSetColumnsValueRelations(List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnConfigDTO> columns) {
        columns.forEach(column -> {
            if (column.isFormat()) {
                List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnCommentValueRelationDTO> columnValueRelations = AuxiliaryKit
                        .parseTableColumnCommentValueRelation(column.get_comment());
                com.rentalHouseAdmin.rha.modules.generator.dto.ColumnsValueRelationDTO columnsValueRelations = new com.rentalHouseAdmin.rha.modules.generator.dto.ColumnsValueRelationDTO();
     ...
     * @param columns 列数据
     */
    public static void handleAndSetAllColumnsValueRelations(List<com.rentalHouseAdmin.rha.modules.generator.dto.TableColumnDTO> columns) {
        columns.forEach(column -> {
            if (column.getDataType().equals("tinyint")) {
                ...
                com.rentalHouseAdmin.rha.modules.generator.dto.ColumnsValueRelationDTO columnsValueRelations = new ColumnsValueRelationDTO();
     ...
     * @return
     */
    public static List<com.rentalHouseAdmin.rha.modules.generator.dto.TableColumnDTO> handleTableColumns(List<com.rentalHouseAdmin.rha.modules.generator.dto.TableColumnDTO> tableColumns) {
     ...
     * @return
     */
    public static List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnConfigDTO> tableColumnsToColumnConfigs(List<com.rentalHouseAdmin.rha.modules.generator.dto.TableColumnDTO> tableColumns) {
        List<com.rentalHouseAdmin.rha.modules.generator.dto.ColumnConfigDTO> columnConfigs = new ArrayList<>();
        tableColumns.forEach(tc -> {
            if (!"PRI".equals(tc.getColumnKey())) {
                com.rentalHouseAdmin.rha.modules.generator.dto.ColumnConfigDTO columnConfig = new ColumnConfigDTO();
    ...
    public static Set<String> getEntityImportPkgs(List<TableColumnDTO> tableColumns) {
        ...
        tableColumns.forEach(tc -> {
            ...
            com.rentalHouseAdmin.rha.modules.generator.constant.JavaTypeEnum javaTypeEnum = JavaTypeEnum.get(javaType);
    ...
    private static com.rentalHouseAdmin.rha.modules.generator.constant.DbColumnTypeEnum getDbColumnTypeEnumByDbDataType(String dataType) {
        com.rentalHouseAdmin.rha.modules.generator.constant.DbColumnTypeEnum dbColumnTypeEnum = DbColumnTypeEnum.get(dataType);
    ...
    public static String getGenerateCodePath(TemplateTypeEnum typeEnum, String moduleName, String funName) {
        com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant.PackageConfig packageConfig = new com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant.PackageConfig();
        ...
        path = com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant.CODE_GEN_PATH + "/" + ConfigConstant.CODE_FOLDER_NAME + "/" + path;
