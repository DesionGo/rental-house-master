package com.rentalHouseAdmin.rha.modules.generator.controller;
...
import com.rentalHouseAdmin.rha.modules.generator.dto.QueryColumnConfigDTO;
import com.rentalHouseAdmin.rha.modules.generator.service.IGenService;
import com.rentalHouseAdmin.rha.modules.generator.service.ITableService;
import com.rentalHouseAdmin.rha.modules.generator.utils.AuxiliaryKit;
import com.rentalHouseAdmin.rha.modules.generator.utils.VelocityKit;
...
import com.rentalHouseAdmin.rha.modules.generator.vo.GenConfigVO;
import com.rentalHouseAdmin.rha.modules.generator.vo.QuicklyGenParamsVO;
...
public class GenController extends BaseController {
    ...
    public ModelAndView setting(@PathVariable String tableName) {
        ...
        List<com.rentalHouseAdmin.rha.modules.generator.dto.TableColumnDTO> tableColumnDTOS = tableService.listTableColumn(tableName);
    ...
    public com.rentalHouseAdmin.rha.common.dto.R listTableData(String tableName, int current, int size) {
        return com.rentalHouseAdmin.rha.common.dto.R.ok(tableService.listTablePage(tableName, current, size));
    }

    @PostMapping(value = "custom/generate/code")
    public com.rentalHouseAdmin.rha.common.dto.R customGenerateCode(@RequestBody com.rentalHouseAdmin.rha.modules.generator.vo.GenConfigVO genConfigVO) {
        ...
        return com.rentalHouseAdmin.rha.common.dto.R.ok(sw.toString().replace(tempUrl, "sys/user/list/data"));
    }

    @PostMapping(value = "quickly/generate/code")
    public com.rentalHouseAdmin.rha.common.dto.R quicklyGenerateCode(com.rentalHouseAdmin.rha.modules.generator.vo.QuicklyGenParamsVO quicklyGenParamsVO) {
    ...
    public com.rentalHouseAdmin.rha.common.dto.R quicklyGenerateCodeBatch(@RequestBody List<QuicklyGenParamsVO> quicklyGenParamsVOS) {
        quicklyGenParamsVOS.forEach(this::quicklyGenerateCode);
        return com.rentalHouseAdmin.rha.common.dto.R.ok();
    }

    @GetMapping(value = "check/codeZip/isExists")
    public com.rentalHouseAdmin.rha.common.dto.R checkCodeZipIsExists() {
        String fileUrl = com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant.CODE_GEN_PATH + "/" + com.rentalHouseAdmin.rha.modules.generator.constant.ConfigConstant.CODE_ZIP_FILENAME;
        File file = new File(fileUrl);
        if (!file.exists()) {
            return com.rentalHouseAdmin.rha.common.dto.R.fail("未找到生成的代码包，请生成代码后再下载。");
        }
        return R.ok();
    }
