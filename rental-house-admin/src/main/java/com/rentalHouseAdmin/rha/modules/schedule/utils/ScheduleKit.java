package com.rentalHouseAdmin.rha.modules.schedule.utils;
...
import com.rentalHouseAdmin.rha.common.utils.SpringContextKit;
...
public class ScheduleKit {
    ...
    private final static Scheduler scheduler = com.rentalHouseAdmin.rha.common.utils.SpringContextKit.getBean(Scheduler.class);

    public static void create(Long jobId, com.rentalHouseAdmin.rha.modules.schedule.entity.Job job) {
        try {
            // 启动调度器
//            scheduler.start();
            //构建job信息
            ...
            throw new com.rentalHouseAdmin.rha.common.exception.KvfException("创建定时任务失败");
        }
    }
    ...
    public static void pause(Long jobId) {
        try {
            ...
            throw new com.rentalHouseAdmin.rha.common.exception.KvfException("暂停定时任务失败");
        }
    }
    ...
    public static void resume(Long jobId) {
        try {
            ...
            throw new com.rentalHouseAdmin.rha.common.exception.KvfException("恢复启动定时任务失败");
        }
    }
    ...
    public static void update(Long jobId, Job job) {
        try {
            ...
            throw new com.rentalHouseAdmin.rha.common.exception.KvfException("更新定时任务失败");
        }
    }
